      ...
      <div className="my-4 w-full rounded-sm border border-blue-200 bg-blue-50 p-6 dark:border-gray-800 dark:bg-blue-opaque">
        ...
        {!session && (
          <div className="my-1 flex flex-col gap-3 sm:flex-row">
            <button
              type="button"
              className="mb-2 mr-2 inline-flex items-center rounded-lg bg-[#24292F] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#24292F]/90 focus:outline-hidden focus:ring-4 focus:ring-[#24292F]/50 dark:hover:bg-[#050708]/30 dark:focus:ring-gray-500"
              onClick={() => {
                void signIn('github');
              }}>
            ...
            <button
              type="button"
              className="dark:focus:ring-[#4285F4]/55 mb-2 mr-2 inline-flex items-center rounded-lg bg-[#4285F4] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#4285F4]/90 focus:outline-hidden focus:ring-4 focus:ring-[#4285F4]/50"
              onClick={() => {
                void signIn('google');
              }}>
        ...
        {session?.user && (
          <form className="relative my-4" onSubmit={(e) => leaveEntry(e)}>
            ...
            />
            <button
              className="absolute right-1 top-1 flex h-8 w-28 items-center justify-center rounded-sm bg-gray-100 px-4 py-1 font-medium text-gray-900 dark:bg-gray-700 dark:text-gray-100"
              type="submit">
