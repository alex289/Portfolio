...
function AnimatedBars() {
  ...
  return (
    <div className="flex items-end w-auto overflow-hidden">
      <span
        id="bar1"
        className="w-1 h-2 bg-gray-300 opacity-75 mr-[3px] dark:bg-gray-500"
      />
      <span
        id="bar2"
        className="w-1 h-1 bg-gray-300 mr-[3px] dark:bg-gray-500"
      />
      <span
        id="bar3"
  ...
  return (
    <div className="flex flex-row-reverse items-center w-full mb-8 sm:flex-row space-x-0 sm:space-x-2">
      {data?.songUrl ? (
        ...
        <svg className="w-4 h-4 ml-auto mt-[-2px]" viewBox="0 0 168 168">
          <path
            fill="#1ED760"
