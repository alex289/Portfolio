    ...
    <>
      {data.map((project: Projects, index: number) => (
        <a
          ...
          <div className="p-6 my-3 border border-gray-200 rounded-lg shadow dark:border-gray-700 grid lg:grid-cols-4 md:grid-cols-2 gap-4 hover:bg-gray-200 dark:hover:bg-gray-700">
